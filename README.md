...
| [elasticbeanstalk](https://github.com/aws-samples/aws-cdk-examples/tree/master/python/elasticbeanstalk/) | Elastic Beanstalk example using L1 with a Blue/Green pipeline (community contributed) |
