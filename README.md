...
| [empty-s3-bucket](https://github.com/aserour/aws-cdk-examples/tree/master/python/empty-s3-bucket) | Empty **(PERMANENTLY DELETE ALL OBJECTS)** in an existing Amazon S3 bucket using StepFunctions
