...
| [dockerized-app](https://github.com/aws-samples/aws-cdk-examples/tree/master/python/dockerized-app-cdk/) | Deploys a containerized app into 3 tiers with userdata in an autoscaling group |
