...
| [ecs-service-with-queue-processing](https://github.com/aws-samples/aws-cdk-examples/tree/master/typescript/ecs/ecs-service-with-queue-processing/) | Starting an ECS service with queue processing, creating a queue processing Ec2 service |
