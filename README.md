...
| [fargate-load-balanced-service-https](https://github.com/aws-samples/aws-cdk-examples/tree/master/typescript/ecs/fargate-load-balanced-service-https/) | Starting a container fronted by a load balancer on Fargate using Route 53 and AWS Certificate Manager to enable SSL |
