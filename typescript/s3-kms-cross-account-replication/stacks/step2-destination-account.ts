import { Stack, StackProps, RemovalPolicy, Fn, CfnOutput, CfnParameter } from 'aws-cdk-lib';
...
export class Step2DestinationAccount extends Stack {
  ...
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    const destinationS3Bucket = new Bucket(this, 'destination-bucket-to-replicate-to', {
