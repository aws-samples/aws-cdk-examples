...
class NihaoECS extends cdk.Stack {
  constructor(scope: cdk.App, id: string, props?: cdk.StackProps) {
    ...
    cluster.addCapacity('DefaultAutoScalingGroup', {
     ...
     // Instantiate ECS Service with cluster and image
    const ecsService = new ecs_patterns.QueueProcessingEc2Service(this, "Ec2Service", {
      cluster,
      memoryLimitMiB: 512,
    ...
    new cdk.CfnOutput(this, 'sqsQueueDNS', { value: ecsService.sqsQueue.queueName});
  }
}

const app = new cdk.App();

new NihaoECS(app, 'Nihao');
