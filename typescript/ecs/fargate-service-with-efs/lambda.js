...
exports.handler = function (event, context, callback) {
  ...
  var volume = {
    ...
    efsVolumeConfiguration: {
      fileSystemId: event["ResourceProperties"]["EfsFileSystemId"],
      rootDirectory: "/",
    },
  };
  ...
  try {
    ...
    ecs.describeTaskDefinition(taskDefParams, function (err, data) {
      ...
      else data["taskDefinition"]["volumes"].push(volume);
      data["taskDefinition"]["containerDefinitions"][0]["mountPoints"].push(
        mountPoint
      );
