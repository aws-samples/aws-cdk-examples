...
import (
	...
	kubectl "github.com/cdklabs/awscdk-kubectl-go/kubectlv34/v2"
)
...
func NewClusterStack(scope constructs.Construct, id string, props *ClusterStackProps) awscdk.Stack {
	...
	eksCluster := awseks.NewCluster(stack, jsii.String("Cluster"), &awseks.ClusterProps{
		...
		KubectlLayer:    kubectl.NewKubectlV34Layer(stack, jsii.String("kubectl134layer")),
		Version:         awseks.KubernetesVersion_V1_34(),
