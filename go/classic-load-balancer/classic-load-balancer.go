...
type ClassicLoadBalancerStackProps struct {
	awscdk.StackProps
}

func NewClassicLoadBalancerStack(scope constructs.Construct, id string, props *ClassicLoadBalancerStackProps) awscdk.Stack {
...
func main() {
	...
	NewClassicLoadBalancerStack(app, "ClassicLoadBalancerStack", &ClassicLoadBalancerStackProps{
		awscdk.StackProps{
			Env: env(),
		},
	})
