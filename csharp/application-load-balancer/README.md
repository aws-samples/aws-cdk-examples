...
This will install the necessary CDK, then this example's dependencies, and then build your CloudFormation template.

## Deploy

Run `cdk deploy ApplicationLoadBalancerStack`. This will deploy / redeploy your Stack to your AWS Account.

After the deployment you will see the API's URL, which represents the url you can then use.

## Synthesize Cloudformation Template

To see the Cloudformation template generated by the CDK, run `cdk synth ApplicationLoadBalancerStack`, then check the output file in the "cdk.out" directory.