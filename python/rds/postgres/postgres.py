...
class Postgres(Stack):
    def __init__(self, scope:Construct, id:str,
                ...
                engine_version = None,      ## Postgres Engine Version
                **kwargs) -> None:
        ...
        if not engine_version:
            engine_version = rds.PostgresEngineVersion.VER_8_0_28
...
app = App()
Postgres(app, "Postgres", env={"region":"us-east-1"}, description="Postgres Instance Stack",
    vpc_id    = "vpc-aaaaaaaa",
