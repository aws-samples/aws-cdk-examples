...
It demonstrates a CDK app with an Application Load Balancer which has a listener configured with targets. The Targets are pointed to an Auto Scaling Group of T2 Micro Amazon Linux based Instances. The stack is called (`LoadBalancerStack`).
