...
public class StaticSiteStack extends Construct {
    ...
    public StaticSiteStack(Construct scope, String id, Map<String,Object> props) {
        ...
        try {
            ...
            final IHostedZone zone = HostedZone.fromLookup(this, "Zone", HostedZoneProviderProps.builder().domainName(props.get("domainName").toString()).build());
        	 
            final String siteDomain = props.get("siteSubDomain").toString() + '.'
                    + props.get("domainName").toString();
            ...
            .value(siteBucket.getBucketName()).build();
            
            // TLS certificate
            final String certificateArn = DnsValidatedCertificate.Builder.create(this, "SiteCertificate")
            		.domainName(siteDomain)
                    .hostedZone(zone).build().getCertificateArn();
            
            CfnOutput.Builder.create(this, "Certificate")
            .description("Certificate ARN")
            .value(certificateArn).build();
            ...
            sourceConfigurationsList.add(SourceConfiguration.builder()
			...
			CloudFrontWebDistribution distribution = CloudFrontWebDistribution.Builder.create(this, "SiteDistribution")
            		.aliasConfiguration(AliasConfiguration.builder()
